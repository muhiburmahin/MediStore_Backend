...
import { wishlistAddSchema, wishlistToggleSchema, wishlistMedicineIdParamValidation, wishlistEntryIdParamValidation, } from "./wishlist.validation";
...
router.delete("/medicine/:medicineId", validateRequest(wishlistMedicineIdParamValidation), wishlistController.removeMedicine);
