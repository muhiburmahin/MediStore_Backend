...
import {
  ...
  medicineListQueryValidation,
  medicineIdParamValidation,
  updateMedicineWithParamsValidation,
...
router.post(
  ...
  validateRequest(createMedicineValidation),
...
router.patch(
  "/:id",
  auth(Role.SELLER, Role.ADMIN),
  validateRequest(updateMedicineWithParamsValidation),
...
router.delete(
  "/:id",
  auth(Role.SELLER, Role.ADMIN),
  validateRequest(medicineIdParamValidation),
